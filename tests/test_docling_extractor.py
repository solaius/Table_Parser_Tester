#!/usr/bin/env python3
"""
Test script for DoclingExtractor.
This script tests the DoclingExtractor with a sample PDF.
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join('logs', 'docling_extractor_test.log'))
    ],
    force=True
)
...
def main():
    """Main function to test the DoclingExtractor."""
    logger.info("Starting DoclingExtractor test")
    ...
    try:
        ...
        logger.error(f"Error testing DoclingExtractor: {e}")
