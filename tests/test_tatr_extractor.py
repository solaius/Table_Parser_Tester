#!/usr/bin/env python3
"""
Test script for TableTransformerExtractor.
This script tests the TableTransformerExtractor with a sample PDF.
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join('logs', 'tatr_extractor_test.log'))
    ],
    force=True
)
...
def main():
    """Main function to test the TableTransformerExtractor."""
    logger.info("Starting TableTransformerExtractor test")
    ...
    try:
        ...
        logger.info("Initializing TableTransformerExtractor...")
        ...
        logger.error(f"Error testing TableTransformerExtractor: {e}")
